 ...
 */
package pkg2.pkg4.pkg5menucorregido;
...
Scanner entrada = new Scanner(System.in);
        ...
        while (true) {
            ...
            switch (opcion) {
                case 1:
                    gestionarCalificaciones(entrada);
                    break;
                case 2:
                    gestionarTiendaDescuento(entrada);
                    break;
                case 3:
                    gestionarCajeroAutomatico(entrada);
                    break;
                case 4:
    ...
    public static void gestionarCalificaciones(Scanner entrada) {
    ...
    public static void gestionarTiendaDescuento(Scanner entrada) {
    ...
    public static void gestionarCajeroAutomatico(Scanner entrada) {
